...
"""Prompt ----> String input to the chatGPT, it is the wrapper class
    chatModels ---> We can interact with LLM by using chatModels
"""
...
if __name__ == '__main__':
    ...
    """Temperature --> will decide how creative language model can be."""
